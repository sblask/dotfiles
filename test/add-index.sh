...
set +o xtrace
actual=$( $SCRIPT_DIRECTORY/../.bin/add-index.symlink --input-type mixed --print-indexables $SCRIPT_DIRECTORY/mixed_in )
set -o xtrace
colordiff --unified <( set +o xtrace; echo "$actual" ) $SCRIPT_DIRECTORY/mixed_out

set +o xtrace
actual=$( $SCRIPT_DIRECTORY/../.bin/add-index.symlink --input-type tree --print-indexables $SCRIPT_DIRECTORY/tree_in )
set -o xtrace
colordiff --unified <( set +o xtrace; echo "$actual" ) $SCRIPT_DIRECTORY/tree_out
