...
set +o xtrace
actual=$( $SCRIPT_DIRECTORY/../.bin/add-index.symlink --input-type ls_list --print-files $SCRIPT_DIRECTORY/ls_list_in )
set -o xtrace
colordiff --unified <( set +o xtrace; echo "$actual" ) $SCRIPT_DIRECTORY/ls_list_plus_files_out

set +o xtrace
actual=$( $SCRIPT_DIRECTORY/../.bin/add-index.symlink --input-type ls_list --print-files $SCRIPT_DIRECTORY/ls_list_colour_in )
set -o xtrace
...
set +o xtrace
actual=$( $SCRIPT_DIRECTORY/../.bin/add-index.symlink --input-type git_status --print-files $SCRIPT_DIRECTORY/git_status_colour_rename_in )
set -o xtrace
